...
class ForwardKin(Node):
    ...
    def __init__(self):
        ...
        self.joint_states_sub = self.create_subscription(
            JointState, "/joint_states", self.forward_kinematics, 10
        )
    ...
    def calc_forward_kinematics(self, theta1, theta2, theta3, theta4, theta5):
    ...
    def forward_kinematics(self, msg):
        ...
        T0E = self.calc_forward_kinematics(theta1, theta2, theta3, theta4, theta5)
        position = T0E[:3, 3]
        rotation = T0E[:3, :3]

...
def public_nav_function(context, *args, **kwargs):
    ...
    tiago_lab2 = get_package_share_directory("tiago_lab2")

    map_path = os.path.join(tiago_lab2, "maps", world_name, "map.yaml")
    rviz_config_file = os.path.join(tiago_lab2, "config", "my_config.rviz")

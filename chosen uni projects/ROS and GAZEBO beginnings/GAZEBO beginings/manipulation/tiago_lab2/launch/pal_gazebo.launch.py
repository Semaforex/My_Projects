...
def start_gzserver(context, *args, **kwargs):
    ...
    priv_pkg_path = ''
    try:
        priv_pkg_path = get_package_share_directory('pal_gazebo_worlds')
    except Exception:
        pass
    ...
    world = ''
    usr_pkg_path = get_package_share_directory('tiago_lab2')
    if os.path.exists(os.path.join(usr_pkg_path, 'worlds', world_name + '.world')):
        world = os.path.join(usr_pkg_path, 'worlds', world_name + '.world')
    elif os.path.exists(os.path.join(usr_pkg_path, 'worlds', world_name + '.world')):
        world = os.path.join(usr_pkg_path, 'worlds', world_name + '.world')
